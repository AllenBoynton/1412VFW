...
@interface Boynton_Allen_Project3Object : KrollCoverageObject {
#else
@interface Boynton_Allen_Project3Object : KrollObject {
#endif
@private
...
extern NSString * Boynton_Allen_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Boynton_Allen_Project3Object *_boynton_allen_project3;
    KrollObject* console;
	BOOL shutdown;
