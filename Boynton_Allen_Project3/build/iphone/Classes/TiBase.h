...
// in simulator we redefine to format for Boynton_Allen_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.boynton_allen_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.boynton_allen_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBoynton_Allen_Project3NativeItemNone = -1, 
	UIBoynton_Allen_Project3NativeItemSpinner = -2,
	UIBoynton_Allen_Project3NativeItemProgressBar = -3,
	
	UIBoynton_Allen_Project3NativeItemSlider = -4,
	UIBoynton_Allen_Project3NativeItemSwitch = -5,
	UIBoynton_Allen_Project3NativeItemMultiButton = -6,
	UIBoynton_Allen_Project3NativeItemSegmented = -7,
	
	UIBoynton_Allen_Project3NativeItemTextView = -8,
	UIBoynton_Allen_Project3NativeItemTextField = -9,
	UIBoynton_Allen_Project3NativeItemSearchBar = -10,
	
	UIBoynton_Allen_Project3NativeItemPicker = -11,
	UIBoynton_Allen_Project3NativeItemDatePicker = -12,
	
	UIBoynton_Allen_Project3NativeItemInfoLight = -13,
	UIBoynton_Allen_Project3NativeItemInfoDark = -14,
	
	UIBoynton_Allen_Project3NativeItemDisclosure = -15,
	
	UIBoynton_Allen_Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Boynton_Allen_Project3 instances of
