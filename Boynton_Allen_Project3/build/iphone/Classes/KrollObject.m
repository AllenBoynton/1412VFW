...
//@interface Boynton_Allen_Project3Object : NSObject
//@end

@interface Boynton_Allen_Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Boynton_Allen_Project3Object class]])
		{
			for (NSString *key in [[(Boynton_Allen_Project3Object*)o modules] allKeys])
			{
