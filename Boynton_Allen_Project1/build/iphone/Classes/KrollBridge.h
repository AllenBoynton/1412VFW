...
@interface Boynton_Allen_Project1Object : KrollCoverageObject {
#else
@interface Boynton_Allen_Project1Object : KrollObject {
#endif
@private
...
extern NSString * Boynton_Allen_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Boynton_Allen_Project1Object *_boynton_allen_project1;
    KrollObject* console;
	BOOL shutdown;
