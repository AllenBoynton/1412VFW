...
// in simulator we redefine to format for Boynton_Allen_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.boynton_allen_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.boynton_allen_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBoynton_Allen_Project1NativeItemNone = -1, 
	UIBoynton_Allen_Project1NativeItemSpinner = -2,
	UIBoynton_Allen_Project1NativeItemProgressBar = -3,
	
	UIBoynton_Allen_Project1NativeItemSlider = -4,
	UIBoynton_Allen_Project1NativeItemSwitch = -5,
	UIBoynton_Allen_Project1NativeItemMultiButton = -6,
	UIBoynton_Allen_Project1NativeItemSegmented = -7,
	
	UIBoynton_Allen_Project1NativeItemTextView = -8,
	UIBoynton_Allen_Project1NativeItemTextField = -9,
	UIBoynton_Allen_Project1NativeItemSearchBar = -10,
	
	UIBoynton_Allen_Project1NativeItemPicker = -11,
	UIBoynton_Allen_Project1NativeItemDatePicker = -12,
	
	UIBoynton_Allen_Project1NativeItemInfoLight = -13,
	UIBoynton_Allen_Project1NativeItemInfoDark = -14,
	
	UIBoynton_Allen_Project1NativeItemDisclosure = -15,
	
	UIBoynton_Allen_Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Boynton_Allen_Project1 instances of
