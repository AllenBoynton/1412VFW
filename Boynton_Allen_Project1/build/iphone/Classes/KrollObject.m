...
//@interface Boynton_Allen_Project1Object : NSObject
//@end

@interface Boynton_Allen_Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Boynton_Allen_Project1Object class]])
		{
			for (NSString *key in [[(Boynton_Allen_Project1Object*)o modules] allKeys])
			{
