...
//Rare exceptions to indicate a bug in the _boynton_allen_project1 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Boynton_Allen_Project1 proxies.
 */
