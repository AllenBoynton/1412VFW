...
@interface Boynton_Allen_Project2Object : KrollCoverageObject {
#else
@interface Boynton_Allen_Project2Object : KrollObject {
#endif
@private
...
extern NSString * Boynton_Allen_Project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Boynton_Allen_Project2Object *_boynton_allen_project2;
    KrollObject* console;
	BOOL shutdown;
