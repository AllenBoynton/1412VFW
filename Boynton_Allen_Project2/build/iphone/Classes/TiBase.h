...
// in simulator we redefine to format for Boynton_Allen_Project2 Developer console
...
{\
	NSString * exceptionName = [@"org.boynton_allen_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.boynton_allen_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBoynton_Allen_Project2NativeItemNone = -1, 
	UIBoynton_Allen_Project2NativeItemSpinner = -2,
	UIBoynton_Allen_Project2NativeItemProgressBar = -3,
	
	UIBoynton_Allen_Project2NativeItemSlider = -4,
	UIBoynton_Allen_Project2NativeItemSwitch = -5,
	UIBoynton_Allen_Project2NativeItemMultiButton = -6,
	UIBoynton_Allen_Project2NativeItemSegmented = -7,
	
	UIBoynton_Allen_Project2NativeItemTextView = -8,
	UIBoynton_Allen_Project2NativeItemTextField = -9,
	UIBoynton_Allen_Project2NativeItemSearchBar = -10,
	
	UIBoynton_Allen_Project2NativeItemPicker = -11,
	UIBoynton_Allen_Project2NativeItemDatePicker = -12,
	
	UIBoynton_Allen_Project2NativeItemInfoLight = -13,
	UIBoynton_Allen_Project2NativeItemInfoDark = -14,
	
	UIBoynton_Allen_Project2NativeItemDisclosure = -15,
	
	UIBoynton_Allen_Project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Boynton_Allen_Project2 instances of
