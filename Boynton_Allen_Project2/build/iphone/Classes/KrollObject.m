...
//@interface Boynton_Allen_Project2Object : NSObject
//@end

@interface Boynton_Allen_Project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Boynton_Allen_Project2Object class]])
		{
			for (NSString *key in [[(Boynton_Allen_Project2Object*)o modules] allKeys])
			{
