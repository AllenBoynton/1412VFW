...
/**
 Base class for all Boynton_Allen_Project2 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Boynton_Allen_Project2 view hierarchy (such as wrapped iOS UIViews) was touched.
