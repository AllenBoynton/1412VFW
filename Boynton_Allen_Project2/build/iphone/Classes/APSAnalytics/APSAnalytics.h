 ...
 * to send analytic data that can be viewed on the Boynton_Allen_Project2 Dashboard.
 *
 * For information on getting started with Boynton_Allen_Project2 Platform Services,
