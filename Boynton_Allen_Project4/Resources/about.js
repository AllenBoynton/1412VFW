...
mainWindow.add(border, dogsSection, detailWindow);
detailWindow.add(detailBorder, dogImageView, trainingText, trainingPercent, trainingFiller, trainingView, strengthText, strengthPercent, strengthFiller, strengthView, descriptionText);
mainWindow.open();	
