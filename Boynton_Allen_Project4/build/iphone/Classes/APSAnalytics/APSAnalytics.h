 ...
 * to send analytic data that can be viewed on the Boynton_Allen_Project4 Dashboard.
 *
 * For information on getting started with Boynton_Allen_Project4 Platform Services,
