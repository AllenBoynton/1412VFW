...
//@interface Boynton_Allen_Project4Object : NSObject
//@end

@interface Boynton_Allen_Project4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Boynton_Allen_Project4Object class]])
		{
			for (NSString *key in [[(Boynton_Allen_Project4Object*)o modules] allKeys])
			{
