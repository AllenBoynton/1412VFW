...
@interface Boynton_Allen_Project4Object : KrollCoverageObject {
#else
@interface Boynton_Allen_Project4Object : KrollObject {
#endif
@private
...
extern NSString * Boynton_Allen_Project4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Boynton_Allen_Project4Object *_boynton_allen_project4;
    KrollObject* console;
	BOOL shutdown;
