...
// in simulator we redefine to format for Boynton_Allen_Project4 Developer console
...
{\
	NSString * exceptionName = [@"org.boynton_allen_project4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.boynton_allen_project4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBoynton_Allen_Project4NativeItemNone = -1, 
	UIBoynton_Allen_Project4NativeItemSpinner = -2,
	UIBoynton_Allen_Project4NativeItemProgressBar = -3,
	
	UIBoynton_Allen_Project4NativeItemSlider = -4,
	UIBoynton_Allen_Project4NativeItemSwitch = -5,
	UIBoynton_Allen_Project4NativeItemMultiButton = -6,
	UIBoynton_Allen_Project4NativeItemSegmented = -7,
	
	UIBoynton_Allen_Project4NativeItemTextView = -8,
	UIBoynton_Allen_Project4NativeItemTextField = -9,
	UIBoynton_Allen_Project4NativeItemSearchBar = -10,
	
	UIBoynton_Allen_Project4NativeItemPicker = -11,
	UIBoynton_Allen_Project4NativeItemDatePicker = -12,
	
	UIBoynton_Allen_Project4NativeItemInfoLight = -13,
	UIBoynton_Allen_Project4NativeItemInfoDark = -14,
	
	UIBoynton_Allen_Project4NativeItemDisclosure = -15,
	
	UIBoynton_Allen_Project4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Boynton_Allen_Project4 instances of
